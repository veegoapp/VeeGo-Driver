          ...
          <View style={[styles.balanceCard, { backgroundColor: colors.secondary, borderColor: '#1e1e2833' }]}>
            ...
            <View style={styles.earningsMini}>
              <View style={styles.earningsMiniItem}>
                ...
                <Text style={[styles.earningsMiniValue, { color: '#2d2d42', fontFamily: 'Inter_700Bold' }]}>+{todayAmount.toFixed(2)} DT</Text>
              </View>
              ...
              <View style={styles.earningsMiniItem}>
                ...
                <Text style={[styles.earningsMiniValue, { color: colors.primary, fontFamily: 'Inter_700Bold' }]}>+{weekTotal.toFixed(2)} DT</Text>
              </View>
              <View style={[styles.earningsMiniDiv, { backgroundColor: colors.border }]} />
              <View style={styles.earningsMiniItem}>
...
const styles = StyleSheet.create({
  ...
  addBtn: { fontSize: 12 },
  methodCard: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12 },
