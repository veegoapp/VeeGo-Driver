...
function makeStyles(S: SplitColors) {
  ...
  vehicleBadge: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, backgroundColor: S.surfaceMuted },
  vehicleBadgeText: { fontSize: 11, letterSpacing: 0.5, color: S.ink },
  seatBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, backgroundColor: S.surfaceMuted },
  ...
  progressFill: { height: '100%', borderRadius: 3, backgroundColor: S.panel },
  ...
  continueBtn: { marginTop: 16, height: 50, borderRadius: 15, backgroundColor: S.panel, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  goToLinesBtn: { marginTop: Spacing.sm, borderRadius: 14, height: 48, width: '100%', backgroundColor: S.panel, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm },
